...
class Layout:
                ...
                html.Div([
                    ...
                    dcc.Upload(
                        ...
                        children=html.Div([
                            ...
                            html.Span("Upload Image", style={'fontWeight': '500', 'fontSize': '14px'})
                    ...
                    html.Div(
                        id=f'image-display-{card_id}',
                        style={**display_item_style, 'flex': 1, 'minHeight': '200px', 'borderRadius': '8px',
                               'backgroundColor': '#0f0f0f'}
                    )
                ], style={'display': 'flex', 'flexDirection': 'column', 'flex': '1', 'height': '100%'}),
    ...
    def build_settings_section(self, text_color):
        ...
        # Style for the new Remove Mask button
        remove_btn_style = {
            "width": "100%",
            "padding": "8px",
            "fontSize": "12px",
        ...
        return html.Div([
            ...
            html.Div([
                ...
                # ADDED: Button to remove the mask
                html.Button('Remove Mask', id='remove-mask-btn', n_clicks=0, style=remove_btn_style)
            ], style={
                'marginBottom': '20px',
                'paddingBottom': '16px',
                'borderBottom': '1px solid #404040'
    ...
    def get_layout(self) -> html.Div:
        ...
        return html.Div([
            ...
            dcc.Loading(
                id="global-upload-loader",
                type="circle",
                fullscreen=True,
                color="#4CAF50",  # Matches your Green Theme
                style={'backgroundColor': 'rgba(0,0,0,0.6)'},  # Dark overlay to block interaction
                children=html.Div(id="global-upload-signal", style={'display': 'none'})
            )
